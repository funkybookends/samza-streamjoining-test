...
public class TweetController
{
	...
	{
		final ReadOnlyKeyValueStore<UUID, UserTweets> store = queryableStoreRegistry.getQueryableStoreType(AnalyticsBinding.TWEETS_STORE, QueryableStoreTypes.keyValueStore());
